...
router.post('/get-new-users-follow-day/',authenticates(['admin']), (req, res) =>{
...
router.post('/get-new-users-follow-year',authenticates(['admin']), (req, res) =>{
    const {year} = req.body; 
...
router.post('/get-new-users-follow-month/',authenticates(['admin']), (req, res) =>{
...
router.post('/get-hot-product-list/', authenticates(['admin']), (req, res) =>{
